...
const MissionVision = () => {
  return (
    <>
      <section className='mt-8 flex flex-col gap-8 lg:mt-16'>
        ...
        <div className='flex flex-col gap-4 lg:h-[80dvh] lg:flex-row lg:gap-8'>
          <div className='w-full p-8 sm:p-16 lg:w-1/2 lg:p-24'>
            <h2 className='text-2xl font-bold sm:text-3xl'>Mission</h2>

            <p className='mt-4 text-gray-500'>
              Seaside Travels is a non-profit organization committed to uniting
              families with unique abilities by offering vital resources and
              educational support on medical topics. Our mission is to build a
              strong community that connects parents and children, fostering
              resilience and understanding. Through compassionate initiatives
              and education, we strive to create a world where every child,
              regardless of their abilities, can thrive and seamlessly integrate
              into society.
            </p>
          </div>
        ...
        <div className='flex flex-col-reverse gap-4 lg:h-[80dvh] lg:flex-row lg:gap-8'>
          <div className='w-full px-4 sm:h-96 sm:px-8 lg:h-full lg:w-1/2 lg:px-16'>
            <img
              alt=''
          ...
          <div className='w-full p-8 sm:p-16 lg:w-1/2 lg:p-24'>
            ...
            <p className='mt-4 text-gray-500'>
              To envision a world where families with unique abilities thrive in
              a supportive and inclusive community, where children are empowered
              to explore the wonders of the world, breaking down societal
        ...
        <div className='grid h-fit grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-8'>
          <div className='p-8 sm:p-16 lg:p-24'>
            ...
            <ul className='mt-4 list-inside list-disc text-gray-500'>
              <li>
                Empowering Families: Provide essential resources and support to
                families with children having unique abilities, creating a
                network that fosters understanding and resilience.
              </li>
              <li>
                Educational Support: Develop and implement educational programs,
                support groups, and outreach initiatives to empower caregivers,
                siblings, and grieving parents in navigating the challenges
                associated with unique abilities.
              </li>
              <li>
              ...
              <li>
                Collaborative Learning: Provide opportunities for individuals to
                learn and contribute, creating a knowledgeable and compassionate
                community that supports those with unique abilities.
              </li>
              <li>
