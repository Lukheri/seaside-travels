    ...
    <section className=''>
      <div className='mt-8 h-[32rem]'>
        <div className='container mx-auto px-6 py-10'>
          <h1 className='text-center font-duke-charming text-3xl font-semibold capitalize lg:text-5xl'>
            Meet the Team
          </h1>
      ...
      <div className='container mx-auto -mt-72 px-6 py-10 sm:-mt-80 md:-mt-96'>
        <div className='mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 xl:mt-16 xl:grid-cols-3'>
          <div className='flex cursor-pointer flex-col  items-center rounded-xl border p-4 sm:p-6'>
            <div className='team-card border'>
              ...
              <div className='team-card__content'>
                <p className='team-card__title'>Courtney Churchill</p>
                ...
                <div className='-mx-2 mt-3 flex'>
                  <a
                    href='#'
                    className='mx-2 text-gray-600 transition-colors duration-300 hover:text-theme-500'
                    aria-label='Reddit'
                  >
                    <svg
            ...
            <p className='mt-2 capitalize text-gray-500'>Co Founder</p>
          </div>
          ...
          <div className='flex cursor-pointer flex-col  items-center rounded-xl border p-4 sm:p-6'>
            <div className='team-card border'>
              ...
              <div className='team-card__content'>
                <p className='team-card__title'>Ariel Price</p>
                <p className='team-card__description'>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                  do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                  Ut enim ad minim veniam, quis nostrud exercitation ullamco.
          ...
          <div className='flex cursor-pointer flex-col  items-center rounded-xl border p-4 sm:p-6'>
            <div className='team-card border'>
              ...
              <div className='team-card__content'>
                <p className='team-card__title'>Michelle Churchill</p>
                <p className='team-card__description'>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                  do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                  Ut enim ad minim veniam, quis nostrud exercitation ullamco.
